package com.cts.freelancer.configuration;
...
@ComponentScans(value={@ComponentScan("com.cts.freelancer.dao"),
		@ComponentScan("com.cts.freelancer.service")
})
public class AppConfig {
	 @Autowired
	   ...
	   public LocalSessionFactoryBean getSessionFactory() {
	      ...
	      factoryBean.setPackagesToScan("com.cts.freelancer.bean");
	      return factoryBean;
	   }
